...
MOCK_COMPLIANCE = [
    {
        ...
        "client_id": "client-1",  # TechNova Solutions
    ...
    },
    {
        ...
        "filing_period": "March 2024",
        "due_date": date.today() - timedelta(days=4), # Overdue > 3 days -> Escalated!
        "status": "Upcoming",
        "assigned_to": "Aditya Rao",
        "escalation_level": 0,
        "risk_level": "LOW",
    ...
    },
    {
        ...
        "client_id": "client-2",  # Apex Innovations
    ...
    },
    {
        ...
        "due_date": date.today() - timedelta(days=1), # Overdue <= 3 days -> Overdue!
        "status": "Upcoming",
        "assigned_to": "Neha Sharma",
        "escalation_level": 0,
        "risk_level": "LOW",
    ...
    },
    {
        ...
        "client_id": "client-3",  # Wayne Enterprises
    ...
    },
    {
        ...
        "client_id": "client-4",  # Global Trade
    ...
    },
    {
        ...
        "filing_period": "FY 2023-24",
        "due_date": date.today() - timedelta(days=5), # Overdue > 3 days -> Escalated!
        "status": "Upcoming",
        "assigned_to": "Neha Sharma",
        "escalation_level": 0,
        "risk_level": "LOW",
    ...
    },
    {
        ...
        "client_id": "client-5",  # Sharma Traders
        "compliance_type": "GSTR-3B",
        "filing_period": "March 2024",
    ...
    },
    {
        ...
        "compliance_type": "TDS Returns",
        "filing_period": "Q4 2023-24",
        "due_date": date.today() - timedelta(days=2), # Overdue <= 3 days -> Overdue!
        "status": "Upcoming",
        "assigned_to": "Kunal Sen",
        "escalation_level": 0,
        "risk_level": "LOW",
    ...
    {
        "compliance_id": "comp-11",
        "client_id": "client-1",  # TechNova Solutions
        "compliance_type": "GSTR-9",
        "filing_period": "FY 2022-23",
    ...
    },
    {
        ...
        "compliance_type": "ITR Filing",
        "filing_period": "AY 2024-25",
        "due_date": date.today() - timedelta(days=12), # Overdue > 3 days -> Escalated!
        "status": "Upcoming",
        "assigned_to": "Rohan Mehta",
        "escalation_level": 0,
        "risk_level": "LOW",
