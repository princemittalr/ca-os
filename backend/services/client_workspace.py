...
MOCK_RECON_HISTORY = [
    {
        ...
        "risk_score": "HIGH",
        "upload_timestamp": datetime(2026, 5, 28, 16, 40)
    },
    {
        "reconciliation_id": "recon-technova-02",
        "client_id": "client-1",
        ...
        "risk_score": "LOW",
        "upload_timestamp": datetime(2026, 4, 15, 11, 20)
    },
    {
        ...
        "itc_at_risk": 32500.0,
        "itc_protected": 120000.0,
        "risk_score": "MEDIUM",
        "upload_timestamp": datetime(2026, 5, 28, 13, 10)
    },
    {
        "reconciliation_id": "recon-wayne-01",
        "client_id": "client-3",
        "filing_period": "2024-03",
        "reconciliation_status": "Fully Matched",
        "total_invoices": 45,
        ...
        "risk_score": "LOW",
        "upload_timestamp": datetime(2026, 5, 27, 10, 15)
    },
    {
        "reconciliation_id": "recon-sharma-01",
        "client_id": "client-5",
        "filing_period": "2024-03",
        "reconciliation_status": "Completed with Mismatches",
        "total_invoices": 10,
        ...
        "missing_in_books_count": 1,
        "itc_at_risk": 85000.0,
        "itc_protected": 45000.0,
        "risk_score": "HIGH",
        "upload_timestamp": datetime(2026, 5, 25, 14, 50)
    }
]
