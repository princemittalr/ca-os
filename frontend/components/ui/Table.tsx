...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-4 text-left align-middle font-semibold uppercase tracking-wider text-slate-500 bg-slate-50 text-[11px]",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("p-4 align-middle text-[13px] text-slate-700 py-3 px-4", className)}
    {...props}
  />
))
